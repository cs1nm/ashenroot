...
static var tile_names: Dictionary = {
	...
	Tile.MAGIC_PORTAL: "Magic Portal",
...
static var tile_colors: Dictionary = {
	...
	Tile.MAGIC_PORTAL: Color("6a4fc8"),
...
static func init_tile_texture_paths() -> void:
	...
	Tile.MAGIC_PORTAL: "res://assets/textures/enemies/anims/portal/portal_anim.png",
